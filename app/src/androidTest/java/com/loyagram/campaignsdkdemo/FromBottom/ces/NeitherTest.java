package com.loyagram.campaignsdkdemo.FromBottom.ces;
...
public class NeitherTest {
    ...
    public void neitherTest() {
        ViewInteraction appCompatRadioButton = onView(
                Matchers.allOf(ViewMatchers.withId(R.id.rdbCes), withText("CES"),
                        childAtPosition(
        ...
        ViewInteraction appCompatRadioButton2 = onView(
                allOf(withText("Neither agree nor disagree"),
                        childAtPosition(
                                childAtPosition(
