package com.loyagram.campaignsdkdemo.FromBottom.csat;
...
public class SomwhatSatTest {

    @Rule
    public ActivityTestRule<MainActivity> mActivityTestRule = new ActivityTestRule<>(MainActivity.class);

    @Test
    public void somwhatTest() {
